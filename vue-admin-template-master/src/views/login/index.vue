	...
	<div class="login-container">
		<el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form" auto-complete="on" label-position="left">
          ...
          <svg-icon icon-class="eye" />
			...
			<!-- <div class="tips">
				<span @click="$router.push('forgetPaw')" style="float:left;margin-left:20px;cursor:pointer;">忘记密码</span>
				<span @click="$router.push('register')" style="float:right;margin-right:20px;cursor:pointer;">去注册</span>
			</div> -->
		</el-form>
	</div>
</template>
